...
ggplot() +
  geom_polygon(data = map_data("world"), aes(x = long, y = lat, group = group), fill="lightgray", colour = "white")  +
  geom_point(data = df, aes(x = long, y = lat, color = province)) +
  theme_base() +
  theme(legend.position = "none")
...
ggplot() +
  geom_polygon(data = map_data("world"), aes(x = long, y = lat, group = group), fill="lightgray", colour = "white")  +
  geom_point(data = df, aes(x = long, y = lat, color = realm)) +
  theme_base() +
  theme(legend.position = "none")
...
ggplot() +
  geom_polygon(data = map_data("world"), aes(x = long, y = lat, group = group), fill="lightgray", colour = "white")  +
  geom_point(data = df, aes(x = long, y = lat, color = lat_zone)) +
  theme_base() +
  theme(legend.position = "none")
...
ggplot() +
  geom_polygon(data = map_data("world"), aes(x = long, y = lat, group = group), fill="lightgray", colour = "white")  +
  geom_point(data = subset(df, !is.na(lme) & lme %ni% lme_remove), aes(x = long, y = lat, color = lme)) +
  theme_base() +
  theme(legend.position = "none")

ggplot() +
  geom_polygon(data = map_data("world"), aes(x = long, y = lat, group = group), fill="lightgray", colour = "white")  +
  geom_point(data = df, aes(x = long, y = lat, color = Temp_C)) +
  theme_base() + 
  theme(plot.background = element_blank())
  
ggplot() +
  geom_polygon(data = map_data("world"), aes(x = long, y = lat, group = group), fill="lightgray", colour = "white")  +
  geom_point(data = df, aes(x = long, y = lat, color = z_prod)) +
  theme_base()

ggplot() +
  geom_polygon(data = map_data("world"), aes(x = long, y = lat, group = group), fill="lightgray", colour = "white")  +
  geom_point(data = df, aes(x = long, y = lat, color = -depth)) +
  theme_base()
...
# # Outfile the data:
ecoregion_cobalt_df <- df2
save(ecoregion_cobalt_df, file = "data/ecoregion_cobalt_variables.Rdata")
...
p1
# ggsave("plots/ecoregions_world_truncated_proportion.png", p1, height = 30 , width = 60, units = "mm", scale = 5)
...
p2
# ggsave("plots/ecoregions_world_predictions.png", p2, height = 30 , width = 60, units = "mm", scale = 5)
...
p3
# ggsave("plots/ecoregions_world_residuals.png", p3, height = 30 , width = 60, units = "mm", scale = 5)
...
p4
# ggsave("plots/ecoregions_world_residuals_trunc.png", p4, height = 30 , width = 60, units = "mm", scale = 5)
