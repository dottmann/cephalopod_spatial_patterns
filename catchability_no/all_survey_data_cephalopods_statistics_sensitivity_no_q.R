...
## All survey data statistics with no catchability coefficient
##
...
## It uses biomass estimates of cephalopods and fish calculated without a cathcability coefficient. 
##
## ---------------------------
...
# Semi variogram; make different types of correlation terms and compare them with an AIC; cut data from 1990 to 201; use log(+1) of exploitation rate; 
# For Aleutian hexagons, use the same exploitation ate as the closest hexgons
