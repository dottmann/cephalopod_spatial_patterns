...
#### Last update: July 2023 by Daniel Otmann
#############################################################
...
# load(file = "data/spp_norway.Rdata")
...
clean.names <- read.delim('data/data Norway/check.Norway.names.WORMS_ceph.csv', sep = ";", stringsAsFactors = T)
...
datalw <- read.csv('data/data Norway/taxa.NorwDat.FB_filled_EU.csv') %>% 
...
ceph_traits <- read.delim("data/norway_cephalopoda_traits2.txt", sep = "\t", stringsAsFactors = T)
...
source('Merge_names_walker-catchability_with_Norway.R')
conversions <- read.csv("data/data Norway/EfficiencyTab.csv",header=T,sep=",")
...
geareff <- read.csv(file = "data/data Norway/EfficiencyTab.csv",sep=",",header = T)
